...
typedef enum
{
    ...
    ERROR_CODE_INCORRECT_MESSAGE_LENGTH,
    ERROR_CODE_INVALID_MESSAGE_VERSION_RECEIVED,
    ERROR_CODE_CRC_OFF_TRAILER_INVALID,
    ERROR_CODE_CRC_ON_CRC_CHECK_FAIL,
    ERROR_CODE_INVALID_CRC_FLAG
