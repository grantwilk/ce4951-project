...
typedef enum
{
    ...
    ERROR_CODE_WRONG_MESSAGE_VERSION_RECEIVED,                    // 0x18

    ERROR_CODE_DRIVER_TIMER_BACKOFF_NOT_INITIALIZED,             // 0x09
    ERROR_CODE_DRIVER_TIMER_BACKOFF_ALREADY_INITIALIZED,         // 0x0A
    ERROR_CODE_DRIVER_TIMER_BACKOFF_NOT_RUNNING,                 // 0x0B
    ERROR_CODE_DRIVER_TIMER_BACKOFF_ALREADY_RUNNING,             // 0x0C
